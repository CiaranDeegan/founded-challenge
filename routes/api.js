...
router.get('/cats', function(req, res) {
    res.json({ urls: ['https://founded.media/hiring/photos/cats/14157413946_fea785b4d6_k.jpg',
...
router.get('/sharks', function(req, res) {
    res.json({ urls: [ 'https://founded.media/hiring/photos/sharks/11261840124_dc9ac72bbe_b.jpg',
